...
public class Simulation2DSandBox : MonoBehaviour
{
  ...
  //  public Vector2 obstacleCentre;
    ...
    public ParticleSpawnerSandBox spawner;
    public ParticleDisplay2DSandBox display;
    ...
    // State
    bool isPaused;
    ParticleSpawnerSandBox.ParticleSpawnData spawnData;
    bool pauseNextFrame;
    ...
    void Start()
    {
        boundsSize = spawner.GetBoundsSize();
        float deltaTime = 1 / 60f;
        Time.fixedDeltaTime = deltaTime;
    }

    public void CreatParicolInSystem()
    {
        
        spawnData = spawner.GetData();
    ...
    void SetInitialBufferData(ParticleSpawnerSandBox.ParticleSpawnData spawnData)
    {
